...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" /> <!--memanggil file asset utuk login page-->
...
<div id="login_box">
    ...
    <?php if (!empty($this->session->flashdata('error'))) : ?><!--menampilkan pesan eror bila salah atau inputan kosong-->
	...
	<p> <!--Button yang di setting bertipe submit-->
