...
<?= form_open($form_action) ?>
    ...
    <div class="row form-group">
        <div class="col-2">
            <?= form_label('NIS / Nama Santri', 'keywords', ['class' => 'label']) ?>
        </div>
        <div class="col-4">
            <?= form_input('keywords', $input->keywords, ['placeholder' => 'Masukkan NIS atau Nama Santri']) ?>
        </div>
        <div class="col-4">
...
<?php if (!$first_load): ?>
    ...
    <div class="row">
        <div class="col-10">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <?= ($i & 1) ? '<tr class="zebra">' : '<tr>'; ?>
                            ...
                            <td><?= $pinjam->nis ?></td>
                            <td><?= $pinjam->nama_santri ?></td>
                            <td><?= $pinjam->nama_kamar ?></td>
            ...
            <?php else: ?>
                <p>Data peminjaman untuk santri tersebut tidak ada, atau buku yang dipinjam sudah dikembalikan.</p>
            <?php endif ?>
        </div>
    </div>
<?php endif ?>
