...
class Peminjaman_model extends MY_Model
{
    ...
    public function getDefaultValues()
    {
        return [
            ...
            'id_santri'       => '',
            'id_buku'        => '',
            'search_santri'   => '', // Fake, just for search
    ...
    public function getAllPeminjaman($page = null)
    {
        ...
        $sql = "    SELECT id_pinjam,
                      ...
                      FROM peminjaman
                INNER JOIN santri
                        ON (peminjaman.id_santri = santri.id_santri)
                INNER JOIN kamar
                        ON (santri.id_kamar = kamar.id_kamar)
                INNER JOIN buku
    ...
    public function liveSearchSantri($keywords)
    {
        return $this->db->select('id_santri, nis, nama_santri')
                        ->like('nis', $keywords)
                        ->or_like('nama_santri', $keywords)
                        ->limit(10)
                        ->get('santri')
                        ->result();
    }
    ...
    public function cekMaxItem($id_santri)
    {
